...
def mido():
    ...
    if sys == 'posix':
        ...
        time.sleep(10)
        os.system(f'{linpath} sideload mido-pe11.zip')
        return
    else:
...
def miatoll():
    ...
    if sys == 'posix':
        ...
        print('you have 10 secs...')
        time.sleep(10)
        os.system(f'{linpath} sideload miatoll-pe12.zip')
        return
    else:
...
def begonia():
    ...
    if sys == 'posix':
        ...
        print('you have 10 secs...')
        time.sleep(10)
        os.system(f'{linpath} sideload begonia-pe12.zip')
        return
    else:
...
def surya():
    ...
    if sys == 'posix':
        ...
        print('you have 10 secs...')
        time.sleep(10)
        os.system(f'{linpath} sideload surya-pe12.zip')
        return
    else:
